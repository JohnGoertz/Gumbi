...
def test_uarray():
    ...
    targets = np.array(
        [
            [0.24886091, 0.29560237, 0.2275221, 0.23869584],
...
def test_uparray():
    ...
    target = np.array(
        [
            [0.11605116, 0.22006429, 0.27902589, 0.34041327],
